    ...
    <div>
      <section>
        <div className="h-dvh relative">
          <img src="/tourinfobg.jpg" className="w-full h-full object-cover" alt="" />
          <div className="container absolute bottom-18.25 left-1/2 -translate-x-1/2">
            <span className="text-white text-[128px] ml-36 font-medium">Oslo</span>
          </div>
        </div>
      </section>
