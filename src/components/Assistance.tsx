    ...
    <div className="h-152.5 overflow-hidden relative">
      ...
      <div className="absolute container  w-full h-full left-1/2 flex items-center  -translate-x-1/2 z-100">
        <div className="flex flex-col px-40 gap-10">  
          <span className="text-white text-[80px] font-medium">Need Assistance</span>
          <span className="text-white max-w-157 text-wrap font-medium text-[32px]">Need Help? Call us drop a message, Our agents will be in touch shortly.</span>
