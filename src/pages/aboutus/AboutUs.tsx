...
const AboutUs = () => {
  return (
    <div>
      <section>
        <div className="h-dvh">
          <img src="/aboutusbg.jpg" className="w-full h-full object-cover" alt="" />
        </div>
      </section>
      <section className="container">
        <div className="px-40 pt-20 pb-25 flex flex-col gap-7.5">
          <span className="text-[48px] text-[#373737] font-medium">About Us</span>
      ...
      <section className="container">
        <div className="px-40 pt-25 pb-31.25">
          <span className="text-[48px] text-[#373737] font-medium">Team</span>
          <div className="grid grid-cols-3 gap-5 mt-13">
            <div className="h-116">
              <img src="/team.jpg" className="w-full object-cover rounded-3xl h-full" alt="team" />
            </div>
            <div className="h-116">
